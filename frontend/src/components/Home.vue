    ...
    <div class="min-h-screen flex flex-col">
        ...
        <header class="bg-gray-900 h-screen flex flex-col p-8 cursor-pointer" @click="scrollToFeatures">
            ...
            <div class="flex h-full items-center">
                    ...
                    <div class="flex-grow flex items-center justify-center md:justify-start">
                        <div class="max-w-2xl">
                            <div class="text-4xl md:text-5xl lg:text-7xl font-bold" ref="titleContainer">
                                ...
                                <h1 class="text-4xl md:text-7xl text-center md:text-left text-white mb-2" v-else
                                    ref="mainTitle">
                                    Welcome to
                                    <br />
                                    ONE.RS
                ...
                <div class="w-1/2 hidden md:flex items-center justify-center overflow-hidden">
                    <img src="../assets/img/oners_homepage.png" alt="Homepage Image" style="width: 200%; height: 200%;"
        ...
        <div v-if="isLoggedIn">
            ...
            <section id="features" v-if="userType == 'supplier'">
                <div class="grid grid-cols-1 md:grid-cols-3 h-screen">
                    ...
                    <div class="flex flex-col justify-between px-5 bg-gray-200 cursor-pointer" ref="ordersCard"
                        ...
                        <div class="hidden md:flex justify-center items-center flex-1">
                            <svg class="h-40 w-40 text-black" width="40" height="40" viewBox="0 0 24 24"
                    ...
                    <div class="flex flex-col h-full px-5" ref="paymentCard" @mouseover="hoverAnimate($event)"
                        ...
                        <!-- Bottom section -->
                        <p class="hide mb-5">Use the chat feature to connect directly with buyers, discuss order
                            details, answer questions, and build trust.</p>
                    </div>
                </div>
                    ...
                    <div class="bg-gray-100 px-5 flex flex-col relative group overflow-hidden"
                        ...
                        <div class="firstFade">
                            ...
                            <div class="secondFade mt-auto mb-5">
                                <p class="hide text-gray-600">Monitor your inventory levels in real-time. Get insights
                                    into your
                    ...
                    <div class="bg-gray-100 px-5 flex flex-col relative group overflow-hidden"
                        ...
                        <div class="firstFade">
                            ...
                            <div class="secondFade">
                                <p class="hide text-gray-600">Where suppliers and restaurants communicate freely across
                                    languages through instant message translation.</p>
                            </div>
                        </div>
            ...
            <section id="features" v-else>
                <div class="grid grid-cols-1 md:grid-cols-3 h-screen cursor-pointer">
                    ...
                    <div class="flex flex-col justify-between px-5 bg-gray-200" ref="orderCard"
                        ...
                        <div class="mb-5">
                            <p class="hide mb-5">As a buyer, you have a credit score to maintain. These will increase
                                for
                                every
                                payment
                                made
                    ...
                    <div class="flex flex-col h-full px-5" ref="paymentCard" @mouseover="hoverAnimate($event)"
                        ...
                        <div class="mb-5">
                            <p class="hide mb-5">Are you overbuying ingredients for your business? Use our order
                                optimiser
                                to
                                analyse your
                ...
                <div class="h-screen grid grid-rows-2 gap-4" ref="bottomGrid">
                    <div class="bg-gray-100 px-5 flex flex-col relative group overflow-hidden"
                        ...
                        <div class="firstFade">
                            ...
                            <div class="secondFade">
                                <p class="hide text-gray-600">Find the ingredients needed for your restaurant using our
                                    AI
                                    Sourcing!
                                    All you need to do is to input your ingredients and let the AI do the rest.</p>
                            </div>
                    ...
                    <div class="bg-gray-100 px-5 flex flex-col relative group overflow-hidden"
                        ...
                        <div class="firstFade">
                            ...
                            <div class="secondFade">
                                <p class="hide text-gray-600">A predictive dashboard that analyses your order history
                                    and
        ...
        <section class="border-bottom" id="features" v-else>
            <div class="grid grid-cols-1 md:grid-cols-3 min-h-screen">
                <!-- AI Sourcing Card -->
                <div class="bg-black text-white px-5 flex flex-col justify-between" @mouseover="hoverAnimate($event)"
                    @mouseout="hoverOffAnimate($event)">
                    <div>
                    ...
                    <div class="mb-5">
                        <p class="hide text-gray-400 md:text-xl">AI-powered sourcing helps you find quality ingredients
                            efficiently by
                ...
                <div class="bg-white px-5 flex flex-col justify-between" @mouseover="hoverAnimate($event)"
                    @mouseout="hoverOffAnimate($event)">
                    <div>
                    ...
                    <div class="mb-5">
                        <p class="hide text-gray-600 md:text-xl">Track supplier inventory, metrics, and compliance in
                            real-time through
                            a
                            single dashboard.</p>
                    </div>
                ...
                <div class="bg-gray-100 px-5 flex flex-col justify-between" @mouseover="hoverAnimate($event)"
                    @mouseout="hoverOffAnimate($event)">
                    <div>
                    ...
                    <div class="mb-5">
                        <p class="hide text-gray-600 md:text-xl">Chat in your language, understood in theirs. Real-time
                            translation for seamless business communication.</p>
                    </div>
                </div>
            </div>
